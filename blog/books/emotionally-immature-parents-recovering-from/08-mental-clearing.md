...
Herein lies the link between EQ and IQ. Both can resist manipulation tactics. High-IQ individuals have an easier time detecting irrationality in the falty logic of the manipulator trying to convince them of something that isn't true. Their capacity for processing complex information is higher, so a manipulator who's trying to use complexity to obfuscate their ill intent won't baffle a high-IQ person easily. Meanwhile, high-EQ individuals have an easier time thinking clearly and so they don't have as many obstacles that would otherwise prevent them from spotting manipulation tactics. Such obstacles include falty beliefs such as that someone's role (e.g., parents, men) necessarily gives them dominion of other people (e.g., adult children, women). High-EQ people don't believe in things that don't sit well with them.
