...
But AI can never beat human creativity. [You are unique. You are creative.]

> It's going to have a much harder time replicating that creativity.

AI is here to automate away the kind of [bureaucracy] that leaves people with no one to turn to when algorithms make mistakes. It's only a question of time before this makes us denounce AI and put an ever greater value on each other. The human ingenuity, our uniqueness, is the future.

[anodyne LLM]: /blog/podcasts/pivot/2025-01-31-deepseek-offbrand-chatgpt.md
<!--0.38--It could be that they had some kind of access to ChatGPT. Certainly some of the data and evidence suggests that in terms of the way that it answers.-->
[bureaucracy]: /blog/books/cloud-storage-security/reading-along/lexisnexis-data-brokering-to-insurers.md
